...
CARDS: dict[str, dict] = {
    ...
    "testing.design_for_testability": {
        "trigger": "any non-trivial business behavior, external dependency, async flow, UI, CLI, persistence, time/ID/randomness, or integration exists.",
        "default_choice": "Design for testability from the start; dependencies must be injectable/replaceable; time, IDs, randomness, external APIs, filesystem, network, queues, and production services must be controllable in tests.",
        "architecture": [
