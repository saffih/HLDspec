...
echo "   Supporting artifacts: manifest, invocation queue, constitution update plan, dependency graph, quality review, and proxy dossier."
echo "3. Discuss and approve/fix the plan before invoking SpecKit."
echo "4. Resolve flagged specs by editing the working HLD.md or HLD-SPECS mapping when needed."
echo "5. Re-run this script with the edited HLD."
echo
